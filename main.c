...
#define I2C_NIXIE_REFRESH_REGISTER 4
#define I2C_NIXIE_PWM_VALUE_REGISTER 5
...
void onWrite(uint8_t reg, uint8_t length) {
  ...
  case I2C_NIXIE_REFRESH_REGISTER:
    break;
...
int main() {
  ...
  if (*i2c_address == 0xff) {
    ...
    SetupI2CSlave(*i2c_address, i2c_registers, sizeof(i2c_registers), onWrite,
                  onRead, false);
