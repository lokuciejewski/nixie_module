...
// #define FUNCONF_ENABLE_HPE 0                // Enable hardware interrupt stack.  Very good on QingKeV4, i.e. x035, v10x, v20x, v30x, but questionable on 003.
//                                             // If you are using that, consider using INTERRUPT_DECORATOR as an attribute to your interrupt handlers.
// #define FUNCONF_USE_5V_VDD 1                // Enable this if you plan to use your part at 5V - affects USB and PD configration on the x035.
